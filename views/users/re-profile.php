...
<div class="row">
    ...
    <div class="col-lg-9">
        <h3>
            <?= $form->field($profileModel, 'users_name')
...
<div class="row">
    ...
    <div class="col-lg-6">
        ...
        <?= $form->field($profileModel, 'imageFile')
...
<div class="row">
    ...
    <div class="col-lg-9">
        <?php
        echo '<h2>' .
            $form->field($profileModel, 'users_info')
                ->textarea(['autofocus' => true, 'rows' => 10, 'cols' => 50])
                ->label(false)
             . '</h2>';
        ?>
    </div>
...
<div class="row">
    ...
    <div class="col-lg-6">
        ...
        if ($ideas || $comments) {
            ...
            echo Html::a(
                'Удалить профиль',
                Url::toRoute(['/users/delete', 'id' => strval($user->id_users),]),
                [
        ...
        <?php
            echo Html::a(
                'Заморозить профиль',
                Url::toRoute(['/users/freeze', 'id' => strval($user->id_users), 'bool' => false]),
                [
    ...
    <div class="pull-right">
        <?php
            echo Html::submitButton(
                'Сохранить',
                ['class' => 'btn btn-info btn-lg', 'name' => 'save-profile-changes-button']
            );
            ?>
        <?php
            echo '<html>
                     <body>
                         <a 
                             href="profile?id=' . strval($user->id_users) . '" 
